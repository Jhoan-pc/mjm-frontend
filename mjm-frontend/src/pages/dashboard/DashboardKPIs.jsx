  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4 mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Status Metrológico</h1>
          <p className="text-sm md:text-base text-gray-500 mt-1">Resumen general de los equipos bajo nuestro alcance.</p>
        </div>
        <button 
          onClick={() => window.print()}
          className="w-full md:w-auto px-6 py-3 text-white font-bold text-xs tracking-widest uppercase rounded shadow-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
