...
import { buildExpectedActivities, calculateMetrologicalCheck } from '../utils/metrologyCore';

export { buildExpectedActivities };
...
export const useInventoryStore = create((set, get) => ({
  ...
  recordPlantCheck: async ({
    ...
    const { vPatron, vLeido, errorVal, consumoPct, declaracion } = calculateMetrologicalCheck({
      valorLeido,
      valorPatron,
      tolerancia: tol
    });
